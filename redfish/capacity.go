...
func (capacitysource *CapacitySource) ProvidingDrives() ([]*Drive, error) {
	return ListReferencedDrives(capacitysource.Client, capacitysource.providingDrives)
}

// ProvidingMemory gets contributing memory.
func (capacitysource *CapacitySource) ProvidingMemory() ([]*Memory, error) {
	return ListReferencedMemorys(capacitysource.Client, capacitysource.providingMemory)
}
