...
func (fileshare *FileShare) EthernetInterfaces() ([]*EthernetInterface, error) {
	return ListReferencedEthernetInterfaces(fileshare.Client, fileshare.ethernetInterfaces)
}
